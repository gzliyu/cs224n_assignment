...
def train_for_epoch(parser, train_data, dev_data, optimizer, loss_func, batch_size):
    ...
    with tqdm(total=(n_minibatches)) as prog:
        for i, (train_x, train_y) in enumerate(minibatches(train_data, batch_size)):
            optimizer.zero_grad()   # 将梯度归零，清空上一次计算的梯度值
            ...
            optimizer.step()    # 最后通过梯度下降执行一步参数更新（梯度由backward产生，optimizer只负责优化）
            ### END YOUR CODE
            prog.update(1)
...
# Epoch 10 out of 10
# 100%|██████████| 1848/1848 [01:07<00:00, 27.26it/s]
# Average Train Loss: 0.030735734117910814
# Evaluating on dev set
# 1445850it [00:00, 94847108.74it/s]
# - dev UAS: 88.59